...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/undernet@3.1.0/dist/undernet.min.css" integrity="sha256-Er7lOA/pLJEdpVIwHaR3/lA8XU6Ls5enfeofmZwuGo4=" crossorigin="anonymous">
```

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/undernet@3.1.0/dist/undernet.bundle.min.js" integrity="sha256-JKSLYQVmSdb/Xs5tYdZnBiSEDy5vSoeAzrp8RsiwXQs=" crossorigin="anonymous"></script>
