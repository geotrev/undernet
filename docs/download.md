...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/undernet@3.1.5/dist/undernet.min.css" integrity="sha256-mv/k5R9Kc0Kz6EaTIKNujXjCzoy0KzuhYEaTlBzLY9o=" crossorigin="anonymous">
```

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/undernet@3.1.5/dist/undernet.bundle.min.js" integrity="sha256-97l2Svc/p58KIDhIr6Lyyb1LjsxYFsiCqS7CcEnPjac=" crossorigin="anonymous"></script>
